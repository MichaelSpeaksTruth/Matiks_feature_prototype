...
// ─────────────────────────────────────────────────────────────────────────────
// Design tokens  (mirror globals.css — kept here for inline styles)
// ─────────────────────────────────────────────────────────────────────────────
const C = {
  black:       "#090909",
  blackSoft:   "#141414",
  ...
  whiteDim:    "#b0b0b0",
  whiteMuted:  "#555555",
  mint:        "#7fffd4",          // aquamarine — used sparingly
  ...
  green:       "#5cdb95",          // safe green (distinct from mint accent)
    ...
    >
      <div className="max-w-3xl mx-auto px-5 flex items-center justify-between" style={{ height: 60 }}>
        ...
        <div className="flex items-center gap-2.5">
          {/* Shield icon — mint accent on black */}
          <div
          ...
          >
            <SvgShield cls="w-[18px] h-[18px]" style={{ color: C.mint } as React.CSSProperties} />
            {/* Live dot */}
            <span
        ...
        {/* Badge — mint on black, used sparingly */}
        <span
    ...
    >
      ...
      {!file && (
        <div className="flex flex-col items-center justify-center gap-4 py-12 px-8 text-center">
          ...
          >
            <SvgUpload cls="w-6 h-6 transition-colors" style={{ color: dragging ? C.mint : C.whiteDim } as React.CSSProperties} />
          </div>
          <div>
            ...
            <p className="text-sm mt-1.5" style={{ color: C.whiteMuted }}>
              or{" "}
              <span className="font-medium underline-offset-2 hover:underline" style={{ color: C.mint }}>
                click to browse
              </span>
            </p>
      ...
      {file && preview && (
        <div className="relative">
          ...
          <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-2">
            ...
            >
              <SvgImage cls="w-3.5 h-3.5 flex-shrink-0" style={{ color: C.mint } as React.CSSProperties} />
            ...
            >
              <SvgX cls="w-3.5 h-3.5" style={{ color: C.whiteDim } as React.CSSProperties} />
            </button>
          </div>
        </div>
      )}
  ...
  return (
    ...
    >
      {[80, 52, 100, 100, 60].map((w, i) => (
        <div
          key={i}
          className="shimmer-bar mb-3"
          style={{ height: i === 0 ? 20 : i < 2 ? 13 : 11, width: `${w}%` }}
        />
      ))}
      <p
        className="text-xs text-center mt-4 flex items-center justify-center gap-2"
        style={{ color: C.whiteMuted }}
      >
        <SvgLoader cls="w-3 h-3" style={{ color: C.mint } as React.CSSProperties} />
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {flagged
            ? <SvgXCircle cls="w-7 h-7" style={{ color: C.red } as React.CSSProperties} />
            : <SvgCheckCircle cls="w-7 h-7" style={{ color: C.green } as React.CSSProperties} />
          }
        </div>
      ...
      <div className="p-6" style={{ background: C.blackCard }}>
        <div className="grid grid-cols-2 gap-4 mb-5">
          ...
          <div
            ...
            style={{ background: C.blackSoft, border: `1px solid ${C.border}` }}
          >
            <p className="text-[10px] uppercase tracking-widest font-semibold mb-2" style={{ color: C.whiteMuted }}>
              is_flagged
            </p>
            <p
              id="is-flagged-value"
        ...
        >
          {flagged
            ? <SvgAlert cls="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: C.red } as React.CSSProperties} />
            : <SvgCheckCircle cls="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: C.green } as React.CSSProperties} />
          }
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 0 30px -8px rgba(255,85,85,0.18)",
      }}
    >
      <div className="flex items-start gap-3">
        <div
          className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5"
          style={{ background: "rgba(255,85,85,0.18)" }}
        >
          <SvgAlert cls="w-4 h-4" style={{ color: C.red } as React.CSSProperties} />
        </div>
        <div>
    ...
    <div className="min-h-screen" style={{ background: C.black }}>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-14">
        ...
        <header className="text-center mb-12">
          {/* Eyebrow badge — mint, used sparingly */}
          <div
        ...
        >
          ...
          <div>
            <label htmlFor="caption-input" className="block text-sm font-semibold mb-2" style={{ color: C.white }}>
              Post Caption{" "}
              <span className="font-normal" style={{ color: C.whiteMuted }}>(optional)</span>
            </label>
            <textarea
              id="caption-input"
              value={caption}
              ...
              onFocus={(e) => {
                e.target.style.borderColor = C.mintBorder;
                e.target.style.boxShadow   = `0 0 0 3px ${C.mintDim}`;
              }}
              onBlur={(e) => {
            ...
            />
            <p className="text-xs text-right mt-1" style={{ color: C.whiteMuted }}>
              {caption.length} / 2000
            </p>
          </div>

          {/* Submit button — white on black when active */}
          <button
            id="submit-btn"
            type="submit"
            disabled={!canSubmit}
